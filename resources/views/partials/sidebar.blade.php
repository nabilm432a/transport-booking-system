<div class="sidebar" style="background-color: #3869d4; display: flex; flex-direction: column; justify-content: space-between; height: 100vh; background-image: url('{{asset("images/peakpx.jpg")}}')">
