<x-layout>
    <div style="margin-left: 30px; margin-top: 20px">
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-4xl"><span
                class="text-transparent bg-clip-text bg-gradient-to-r to-blue-800 from-blue-300">Transports</span></h1>
    </div>

    <div>
        <div style="display: flex; flex-direction: column; align-items: center">

            <a href="{{route('transports.create')}}" style="width: 50%">
                <button
        ...
        <div style="display: flex; justify-content: center; align-items: center; padding-bottom: .5rem; margin-top: 10px">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3" style="text-align: center;">Type</th>
                ...
                @foreach($transports as $transport)
                    <tr class="bg-gray-100">
                        <td style="text-align: center;">{{$transport->id}}</td>
                        <td style="text-align: center;">{{$transport->license}}</td>
                        ...
                        <td style="display: flex; align-items: center; justify-content: center; gap: 10px;">
                            ...
                            <form
                                  method="POST" action="{{route('transports.destroy', $transport)}}">
                                @csrf
                                @method('DELETE')
